      ...
      <main className="landingMainContainer">
        ...
        <div className="landingContent">
          ...
          <div className="heroBadge">
            ...
            Fast, secure & seamless video meetings
          </div>
          ...
          <p>
            Experience seamless video conversations with JudoCall.
            Meet, collaborate and stay connected from anywhere in the world.
          </p>
